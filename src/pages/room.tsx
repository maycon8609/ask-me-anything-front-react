  ...
  return (
    <div className="mx-auto max-w-[640px] flex flex-col gap-6 py-10 px-4">
      ...
      <ol className="list-decimal list-outside px-3 space-y-8">
        <Message
          text="Lorem ipsum dolor sit amet consectetur adipisicing elit. Consectetur ea quibusdam reiciendis ab ex voluptatum exercitationem cumque, dolores voluptate odio minima quod iure quam quis et eaque excepturi ipsam! Voluptates."
          reactionsCount={2}
          answered
        />
        <Message
